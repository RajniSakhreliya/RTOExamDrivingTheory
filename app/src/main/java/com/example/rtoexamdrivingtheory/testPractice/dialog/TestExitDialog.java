...
public class TestExitDialog extends Dialog {
    ...
    public TestExitDialog(@NonNull Activity context) {
        super(context);
        activity = context;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(activity.getResources().getString(R.string.mock_test));
        setMessage(activity.getResources().getString(R.string.doYouWantToEndTest));
        setPositiveBtn(activity.getResources().getString(R.string.exit));
    ...
    onPositiveBtnClick onPositiveClick;

    public void setOnPositiveClick(onPositiveBtnClick onPositiveClick) {
        this.onPositiveClick = onPositiveClick;
    }

    onNegativeBtnClick onNegativeClick;

    public void setOnNegativeClick(onNegativeBtnClick onNegativeClick) {
